...
<!-- footer content -->
        <footer>
          <div class="pull-right">
            UKK SMKN 1 JENANGAN by <a href="#">Achmad Torikul Huda</a>
          </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function requestData() {
                ...
                xhr = $.ajax('request_pdo.php')
                .done(function(data) {
                    $('div[data-api]').html(data.api);
                    $('div[data-asap]').html(data.asap);
                    $('div[data-status]').html(data.status);
